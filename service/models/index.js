...
/* ================= USER → CURRENT UNIT ================= */
User.belongsTo(Unit, { foreignKey: "unitId", as: "currentUnit" });

/* ================= UNIT STRUCTURE ================= */
Floor.belongsTo(Unit, { foreignKey: "unitId" });
Unit.hasMany(Floor, { foreignKey: "unitId" });
...
Software_Ticket_Details.belongsTo(
  Software_Ref_Ticket_Status,
  { foreignKey: "ticket_status_Id" }
);
Software_Ref_Ticket_Status.hasMany(
  Software_Ticket_Details,
  { foreignKey: "ticket_status_Id" }
);
