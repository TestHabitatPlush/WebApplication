...
exports.updateBuilding = async (req, res) => {
  try {
    ...
    console.log("Update Request - buildingId:", buildingId);
    console.log("Update Request - buildingName:", buildingName);
    ...
    if (buildingName && buildingName !== existingBuilding.buildingName) {
      const conflict = await Building.findOne({
        where: {
          buildingName: { [Op.like]: buildingName }, // ✅ fixed here
    ...
    await existingBuilding.update({ buildingName });
