...
//     // Special redirect for privileged roles
//     if (
//       ["super_admin", "society_moderator", "management_committee"].includes(user.role.roleCategory)
//     ) {
...
//         password,
//         role: {
//           roleCategory: user.role.roleCategory,
//         },
//       }, "1h");
...
//     const { email, password, role } = verifyToken(token);
//     const user = await User.findOne({
//       where: { email },
//       include: [{ model: Role, as: "role" }, { model: Customer }],
//     });
...
//           email,
//           password,
//           role: { roleCategory: profile.role.roleCategory },
//         }
//       : {
//           profileId: profile.profileId,
//           email: profile.email,
...
//       email: profile.email,
//       role: {
//         roleCategory: profile.role.roleCategory,
//       },
//     });
