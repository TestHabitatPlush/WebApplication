...
const CustomerSubscriptionList = () => {
  ...
  const {
    ...
    getAllModulesHandler, // ✅ make sure you have this in your handler
  } = SubscriptionHandler();
  ...
  const fetchModules = async () => {
    try {
      const result = await getAllModulesHandler(token);
    ...
    <div className="relative p-5">
      ...
      {showUpdateModal && selectedSubscription && (
        <UpdateSubscriptionDetailsModal
          ...
          onEditHandler={handleUpdateSubscription}
          modules={allModules} // ✅ pass modules
        />
      )}
