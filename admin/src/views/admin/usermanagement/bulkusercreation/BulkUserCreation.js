            ...
            <div className='flex'>
                <div className='w-full'>
                    ...
                    <div className='flex flex-col mt-[35px] space-y-3'>
                        <div className='flex justify-end mr-12 gap-8'>
                            <button className='flex gap-2 bg-green-600 p-2 rounded-md text-white'>Upload File <TiArrowUpThick className='mt-1'/>
                            <input type="file" onChange={handleUpload}/>
                            </button>
                            <button onClick={() => downloadFormatFile(format)} className='flex gap-2 bg-green-600 p-2 rounded-md text-white'>Download Format<TiArrowDownOutline className='mt-1' /></button>
                        </div>
