...
const CreateTicketForm = () => {
  ...
  const { ticketPurpousListView, createTicket, getTicketCatagorisation } = SoftwareHelpDeskHandler();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const purposeRes = await ticketPurpousListView();
        setTicketPurpousList(purposeRes.data.data);
        const catRes = await getTicketCatagorisation();
        setTicketCatagorisation(catRes.data.data);
      } catch (err) {
