...
//   const assignedTo = ticket.Ticket_Details?.[0]?.assigned_to || "—";
//   const updatedBy = ticket.Ticket_Details?.[0]?.updated_by_user_id || "—";

//   // 🟡 Changed: Remove fallback value "—" in the attachment path
//   const attachmentPath =
//     ticket.Ticket_Details?.[0]?.ticket_attachment_details || "";
...
//           {/* 🟢 Updated: Render attachment as image instead of showing raw URL */}
//           <li className="flex items-start gap-4 p-4 bg-white rounded-md shadow-sm">
