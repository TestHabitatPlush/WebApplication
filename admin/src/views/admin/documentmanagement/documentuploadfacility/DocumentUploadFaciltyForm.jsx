...
// // Aligns with backend's visibilityMap
// const visibilityMap = {
...
//         if (visibilityFilter) {
//           const matchCategories = visibilityMap[visibilityFilter] || [];
//           allDocs = allDocs.filter((doc) =>
//             Array.isArray(doc.roleCategories)
//               ? matchCategories.some((cat) => doc.roleCategories.includes(cat))
//               : false
//           );
//         }
  ...
  return (
    <div className="px-5">
      <div className="p-10 my-5 border rounded-lg bg-gray-100">
        ...
        {errors.visibilityOption && <p className="text-red-500 text-sm">{errors.visibilityOption}</p>}
