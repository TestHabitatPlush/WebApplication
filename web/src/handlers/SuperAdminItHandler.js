...
} from "@/services/superAdminItService";

const SuperAdminItHandler = () => {
...
//   const updateTicketStatusAndRemarks = async (ticket_Id, data) => {
//   try {
//     const res = await updateTicketStatusAndRemarksService(ticket_Id, data, token);
//     console.log("updateTicketStatusAndRemarks res", res);
//     if (res.status === 200) {
//       toast.success("Ticket updated.");
//       return res.data;
//     }
...
export default SuperAdminItHandler;
