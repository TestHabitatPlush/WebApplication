...
// import TicketListView from "@/views/softwarehelpdesk/TicketListView";
// import TicketListEdit from "@/views/softwarehelpdesk/TicketListEdit";
...
//           (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
//         )[0];
//         // console.log("latesrtDetail", latestDetail);
//         // return latestDetail?.assigned_to || "—";
