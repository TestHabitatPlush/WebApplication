...
//                         className="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-turquoise"
//                       />
//                     ) : (
//                       <input
//                         id={field.name}
...
//               {/* Action Buttons */}
//               <div className="flex justify-center gap-4 mt-6 align-middle">
//                 <Button
//                   type="submit"
//                   className="w-32 px-4 py-2 text-sm text-white bg-green-500 hover:bg-green-600"
//                 >
//                   Submit
//                 </Button>
//               </div>
